"""
Django settings for talent_event_backend project.
...
ROOT_URLCONF = 'talent_event_backend.urls'
...
WSGI_APPLICATION = 'talent_event_backend.wsgi.application'
